...
local function get_jdtls_paths()
  ...
  local java_debug_bundle = vim.split(vim.fn.glob(java_debug_path .. 'plugins/org.eclipse.equinox.launcher_*.jar'), '\n')
  ...
  path.runtimes = {
    ...
    {
      name = 'JavaSE-17',
      path = vim.fn.expand 'C:/Program Files/Java/jdk-17/bin',
    },
    {
      name = 'JavaSE-21',
      path = vim.fn.expand 'C:/Program Files/Java/jdk-21/bin',
    },
  }
